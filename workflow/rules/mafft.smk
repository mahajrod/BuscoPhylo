...
rule mafft_dna:
    input:
        ...
        fna=expand(expand_template_from_merged_sequences(wildcards, mafft_dir_path / "{sample}.fna"))
    output:
...
rule mafft_protein:
    input:
        ...
        faa=expand(expand_template_from_merged_sequences(wildcards, mafft_dir_path / "{sample}.faa"))
    output:
