...
rule mafft_dna:
    input:
        ...
        fna=expand(lambda w: expand_template_from_merged_sequences(w,mafft_dir_path / "{sample}.fna"))
    output:
...
rule mafft_protein:
    input:
        ...
        faa=expand(lambda w: expand_template_from_merged_sequences(w,mafft_dir_path / "{sample}.faa"))
    output:
