...
rule gblocks:
    ...
    shell:
        ...
        "FILE=$(basename $FILE); "
        "{params.gblocks_path}/Gblocks {params.mafft_dir}/merged_$FILE.fna {params.gblocks_dna_flags} 1> {log.std}; "
        "{params.gblocks_path}/Gblocks {params.mafft_dir}/merged_$FILE.faa {params.gblocks_protein_flags} 1> {log.std}; "
